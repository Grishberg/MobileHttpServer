 ...
 */
public class Const {
    public static final String SERVICE_ACTION_TASK_DONE = "taskDoneAction";
    public static final String SERVICE_ACTION_TASK_FAIL = "taskFailAction";
    public static final String EXTRA_TASK_CODE = "extraTaskCode";
    public static final String EXTRA_TASK_TAG = "extraAccessToken";
